...
`+JSON.stringify(i,null,2):l=" "+this.formatData(i));let g="";if(n){let{sessionId:f,sdkSessionId:y,correlationId:E,...r}=n;Object.keys(r).length>0&&(g=` {${Object.entries(r).map(([O,h])=>`${O}=${h}`).join(", ")}}`)}let N=`[${a}] [${d}] [${u}] ${S}${t}${g}${l}`;e===3?console.error(N):console.log(N)}debug(e,s,t,n){this.log(0,e,s,t,n)}info(e,s,t,n){this.log(1,e,s,t,n)}warn(e,s,t,n){this.log(2,e,s,t,n)}error(e,s,t,n){this.log(3,e,s,t,n)}dataIn(e,s,t,n){this.info(e,`\u2192 ${s}`,t,n)}dataOut(e,s,t,n){this.info(e,`\u2190 ${s}`,t,n)}success(e,s,t,n){this.info(e,`\u2713 ${s}`,t,n)}failure(e,s,t,n){this.error(e,`\u2717 ${s}`,t,n)}timing(e,s,t,n){this.info(e,`\u23F1 ${s}`,n,{duration:`${t}ms`})}},U=new oe;var $=class{static DEFAULTS={CLAUDE_MEM_MODEL:"claude-haiku-4-5",CLAUDE_MEM_CONTEXT_OBSERVATIONS:"50",CLAUDE_MEM_WORKER_PORT:"37777",CLAUDE_MEM_WORKER_HOST:"127.0.0.1",CLAUDE_MEM_SKIP_TOOLS:"ListMcpResourcesTool,SlashCommand,Skill,TodoWrite,AskUserQuestion",CLAUDE_MEM_DATA_DIR:(0,ge.join)((0,Se.homedir)(),".claude-mem"),CLAUDE_MEM_LOG_LEVEL:"INFO",CLAUDE_MEM_PYTHON_VERSION:"3.13",CLAUDE_CODE_PATH:"",CLAUDE_MEM_CONTEXT_SHOW_READ_TOKENS:"true",CLAUDE_MEM_CONTEXT_SHOW_WORK_TOKENS:"true",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT:"true",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_PERCENT:"true",CLAUDE_MEM_CONTEXT_OBSERVATION_TYPES:me,CLAUDE_MEM_CONTEXT_OBSERVATION_CONCEPTS:Te,CLAUDE_MEM_CONTEXT_FULL_COUNT:"5",CLAUDE_MEM_CONTEXT_FULL_FIELD:"narrative",CLAUDE_MEM_CONTEXT_SESSION_COUNT:"10",CLAUDE_MEM_CONTEXT_SHOW_LAST_SUMMARY:"true",CLAUDE_MEM_CONTEXT_SHOW_LAST_MESSAGE:"false"};static getAllDefaults(){return{...this.DEFAULTS}}static get(e){return this.DEFAULTS[e]}static getInt(e){let s=this.get(e);return parseInt(s,10)}static getBool(e){return this.get(e)==="true"}static loadFromFile(e){if(!(0,B.existsSync)(e))return this.getAllDefaults();let s=(0,B.readFileSync)(e,"utf-8"),t=JSON.parse(s),n=t;if(t.env&&typeof t.env=="object"){n=t.env;try{(0,B.writeFileSync)(e,JSON.stringify(n,null,2),"utf-8"),U.info("SETTINGS","Migrated settings file from nested to flat schema",{settingsPath:e})}catch(a){U.warn("SETTINGS","Failed to auto-migrate settings file",{settingsPath:e},a)}}let i={...this.DEFAULTS};for(let a of Object.keys(this.DEFAULTS))n[a]!==void 0&&(i[a]=n[a]);return i}};var We={};function Xe(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,fe.fileURLToPath)(We.url))}var us=Xe(),v=$.get("CLAUDE_MEM_DATA_DIR"),ie=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,he.homedir)(),".claude"),ps=(0,b.join)(v,"archives"),ls=(0,b.join)(v,"logs"),Es=(0,b.join)(v,"trash"),ms=(0,b.join)(v,"backups"),Ts=(0,b.join)(v,"settings.json"),Oe=(0,b.join)(v,"claude-mem.db"),gs=(0,b.join)(v,"vector-db"),Ss=(0,b.join)(ie,"settings.json"),hs=(0,b.join)(ie,"commands"),bs=(0,b.join)(ie,"CLAUDE.md");function Re(c){(0,be.mkdirSync)(c,{recursive:!0})}var J=class{db;constructor(){Re(v),this.db=new Ne.Database(Oe),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn()}initializeSchema(){try{this.db.run(`
    ...
    `).get(e)?.worker_port||null}saveUserPrompt(e,s,t){let n=new Date,i=n.getTime();return this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?)
    `).run(e,s,t,n.toISOString(),i).lastInsertRowid}saveHistoricalUserPrompt(e,s,t,n){let i=n.getTime();return this.db.prepare(`
      INSERT INTO user_prompts
      (claude_session_id, prompt_number, prompt_text, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?)
    ...
    `).get(e)||(this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,s,t.type,t.title,t.subtitle,JSON.stringify(t.facts),t.narrative,JSON.stringify(t.concepts),JSON.stringify(t.files_read),JSON.stringify(t.files_modified),n||null,i,a.toISOString(),d);return{id:Number(g.lastInsertRowid),createdAtEpoch:d}}storeHistoricalObservation(e,s,t,n,i,a=0){let d=n.getTime();this.db.prepare(`
      SELECT id FROM sdk_sessions WHERE sdk_session_id = ?
    `).get(e)||(this.db.prepare(`
        INSERT INTO sdk_sessions
        (claude_session_id, sdk_session_id, project, started_at, started_at_epoch, status)
        VALUES (?, ?, ?, ?, ?, 'active')
      `).run(e,e,s,n.toISOString(),d),console.error(`[SessionStore] Auto-created historical session record for: ${e}`));let g=this.db.prepare(`
      INSERT INTO observations
      (sdk_session_id, project, type, title, subtitle, facts, narrative, concepts,
       files_read, files_modified, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,s,t.type,t.title,t.subtitle,JSON.stringify(t.facts),t.narrative,JSON.stringify(t.concepts),JSON.stringify(t.files_read),JSON.stringify(t.files_modified),i||null,a,n.toISOString(),d);return{id:Number(g.lastInsertRowid),createdAtEpoch:d}}storeSummary(e,s,t,n,i=0){let a=new Date,d=a.getTime();this.db.prepare(`
      SELECT id FROM sdk_sessions WHERE sdk_session_id = ?
    `).get(e)||(this.db.prepare(`
        INSERT INTO sdk_sessions
        (claude_session_id, sdk_session_id, project, started_at, started_at_epoch, status)
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,s,t.request,t.investigated,t.learned,t.completed,t.next_steps,t.notes,n||null,i,a.toISOString(),d);return{id:Number(g.lastInsertRowid),createdAtEpoch:d}}storeHistoricalSummary(e,s,t,n,i,a=0){let d=n.getTime();this.db.prepare(`
      SELECT id FROM sdk_sessions WHERE sdk_session_id = ?
    `).get(e)||(this.db.prepare(`
        INSERT INTO sdk_sessions
        (claude_session_id, sdk_session_id, project, started_at, started_at_epoch, status)
      ...
      (sdk_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,s,t.request,t.investigated,t.learned,t.completed,t.next_steps,t.notes,i||null,a,n.toISOString(),d);return{id:Number(g.lastInsertRowid),createdAtEpoch:d}}markSessionCompleted(e){let s=new Date,t=s.getTime();this.db.prepare(`
      UPDATE sdk_sessions
    ...
    `).all(...e)}getUserPromptsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n}=s,i=t==="date_asc"?"ASC":"DESC",a=n?`LIMIT ${n}`:"",d=e.map(()=>"?").join(",");return this.db.prepare(`
      ...
      ${a}
    `).all(...e)}getTimelineAroundTimestamp(e,s=10,t=10,n){return this.getTimelineAroundObservation(null,e,s,t,n)}getTimelineAroundObservation(e,s,t=10,n=10,i){let a=i?"AND project = ?":"",d=i?[i]:[],u,S;if(e!==null){let f=`
...
`).filter(n=>n.trim()),t="";for(let n=s.length-1;n>=0;n--)try{let i=s[n];if(!i.includes('"type":"assistant"'))continue;let a=JSON.parse(i);if(a.type==="assistant"&&a.message?.content&&Array.isArray(a.message.content)){let d="";for(let u of a.message.content)u.type==="text"&&(d+=u.text);if(d=d.replace(/<system-reminder>[\s\S]*?<\/system-reminder>/g,"").trim(),d){t=d;break}}}catch{continue}return{userMessage:"",assistantMessage:t}}catch(e){return U.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:c},e),{userMessage:"",assistantMessage:""}}}async function Qe(c,e=!1){let s=He(),t=c?.cwd??process.cwd(),n=t?w.default.basename(t):"unknown-project",i=null;try{i=new J}catch(L){if(L.code==="ERR_DLOPEN_FAILED"){try{(0,H.unlinkSync)(Be)}catch{}return console.error("Native module rebuild needed - restart Claude Code to auto-fix"),""}throw L}let a=Array.from(s.observationTypes),d=a.map(()=>"?").join(","),u=Array.from(s.observationConcepts),S=u.map(()=>"?").join(","),l=i.db.prepare(`
  ...
  `).all(n,...a,...u,s.totalObservationCount),g=i.db.prepare(`
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(n,s.sessionCount+Ge),N="",f="";if(s.showLastMessage&&l.length>0)try{let L=c?.session_id,O=l.find(h=>h.sdk_session_id!==L);if(O){let h=O.sdk_session_id,D=qe(t),F=w.default.join((0,z.homedir)(),".claude","projects",D,`${h}.jsonl`),G=Je(F);N=G.userMessage,f=G.assistantMessage}}catch{}if(l.length===0&&g.length===0)return i?.close(),e?`
...
No previous sessions found for this project yet.`;let y=g.slice(0,s.sessionCount),E=l,r=[];if(e?(r.push(""),r.push(`${o.bright}${o.cyan}[${n}] recent context${o.reset}`),r.push(`${o.gray}${"\u2500".repeat(60)}${o.reset}`),r.push("")):(r.push(`# [${n}] recent context`),r.push("")),E.length>0){e?r.push(`${o.dim}Legend: \u{1F3AF} session-request | \u{1F534} bugfix | \u{1F7E3} feature | \u{1F504} refactor | \u2705 change | \u{1F535} discovery | \u2696\uFE0F  decision${o.reset}`):r.push("**Legend:** \u{1F3AF} session-request | \u{1F534} bugfix | \u{1F7E3} feature | \u{1F504} refactor | \u2705 change | \u{1F535} discovery | \u2696\uFE0F  decision"),r.push(""),e?(r.push(`${o.bright}\u{1F4A1} Column Key${o.reset}`),r.push(`${o.dim}  Read: Tokens to read this observation (cost to learn it now)${o.reset}`),r.push(`${o.dim}  Work: Tokens spent on work that produced this record (\u{1F50D} research, \u{1F6E0}\uFE0F building, \u2696\uFE0F  deciding)${o.reset}`)):(r.push("\u{1F4A1} **Column Key**:"),r.push("- **Read**: Tokens to read this observation (cost to learn it now)"),r.push("- **Work**: Tokens spent on work that produced this record (\u{1F50D} research, \u{1F6E0}\uFE0F building, \u2696\uFE0F  deciding)")),r.push(""),e?(r.push(`${o.dim}\u{1F4A1} Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${o.reset}`),r.push(""),r.push(`${o.dim}When you need implementation details, rationale, or debugging context:${o.reset}`),r.push(`${o.dim}  - Use the mem-search skill to fetch full observations on-demand${o.reset}`),r.push(`${o.dim}  - Critical types (\u{1F534} bugfix, \u2696\uFE0F decision) often need detailed fetching${o.reset}`),r.push(`${o.dim}  - Trust this index over re-reading code for past decisions and learnings${o.reset}`)):(r.push("\u{1F4A1} **Context Index:** This semantic index (titles, types, files, tokens) is usually sufficient to understand past work."),r.push(""),r.push("When you need implementation details, rationale, or debugging context:"),r.push("- Use the mem-search skill to fetch full observations on-demand"),r.push("- Critical types (\u{1F534} bugfix, \u2696\uFE0F decision) often need detailed fetching"),r.push("- Trust this index over re-reading code for past decisions and learnings")),r.push("");let L=l.length,O=l.reduce((_,m)=>{let T=(m.title?.length||0)+(m.subtitle?.length||0)+(m.narrative?.length||0)+JSON.stringify(m.facts||[]).length;return _+Math.ceil(T/Ae)},0),h=l.reduce((_,m)=>_+(m.discovery_tokens||0),0),D=h-O,F=h>0?Math.round(D/h*100):0,G=s.showReadTokens||s.showWorkTokens||s.showSavingsAmount||s.showSavingsPercent;if(G)if(e){if(r.push(`${o.bright}${o.cyan}\u{1F4CA} Context Economics${o.reset}`),r.push(`${o.dim}  Loading: ${L} observations (${O.toLocaleString()} tokens to read)${o.reset}`),r.push(`${o.dim}  Work investment: ${h.toLocaleString()} tokens spent on research, building, and decisions${o.reset}`),h>0&&(s.showSavingsAmount||s.showSavingsPercent)){let _="  Your savings: ";s.showSavingsAmount&&s.showSavingsPercent?_+=`${D.toLocaleString()} tokens (${F}% reduction from reuse)`:s.showSavingsAmount?_+=`${D.toLocaleString()} tokens`:_+=`${F}% reduction from reuse`,r.push(`${o.green}${_}${o.reset}`)}r.push("")}else{if(r.push("\u{1F4CA} **Context Economics**:"),r.push(`- Loading: ${L} observations (${O.toLocaleString()} tokens to read)`),r.push(`- Work investment: ${h.toLocaleString()} tokens spent on research, building, and decisions`),h>0&&(s.showSavingsAmount||s.showSavingsPercent)){let _="- Your savings: ";s.showSavingsAmount&&s.showSavingsPercent?_+=`${D.toLocaleString()} tokens (${F}% reduction from reuse)`:s.showSavingsAmount?_+=`${D.toLocaleString()} tokens`:_+=`${F}% reduction from reuse`,r.push(_)}r.push("")}let Le=g[0]?.id,Ce=y.map((_,m)=>{let T=m===0?null:g[m+1];return{..._,displayEpoch:T?T.created_at_epoch:_.created_at_epoch,displayTime:T?T.created_at:_.created_at,shouldShowLink:_.id!==Le}}),ve=new Set(l.slice(0,s.fullObservationCount).map(_=>_.id)),ae=[...E.map(_=>({type:"observation",data:_})),...Ce.map(_=>({type:"summary",data:_}))];ae.sort((_,m)=>{let T=_.type==="observation"?_.data.created_at_epoch:_.data.displayEpoch,M=m.type==="observation"?m.data.created_at_epoch:m.data.displayEpoch;return T-M});let j=new Map;for(let _ of ae){let m=_.type==="observation"?_.data.created_at:_.data.displayTime,T=Ye(m);j.has(T)||j.set(T,[]),j.get(T).push(_)}let ye=Array.from(j.entries()).sort((_,m)=>{let T=new Date(_[0]).getTime(),M=new Date(m[0]).getTime();return T-M});for(let[_,m]of ye){e?(r.push(`${o.bright}${o.cyan}${_}${o.reset}`),r.push("")):(r.push(`### ${_}`),r.push(""));let T=null,M="",x=!1;for(let Z of m)if(Z.type==="summary"){x&&(r.push(""),x=!1,T=null,M="");let p=Z.data,P=`${p.request||"Session started"} (${je(p.displayTime)})`,C=p.shouldShowLink?`claude-mem://session-summary/${p.id}`:"";if(e){let R=C?`${o.dim}[${C}]${o.reset}`:"";r.push(`\u{1F3AF} ${o.yellow}#S${p.id}${o.reset} ${P} ${R}`)}else{let R=C?` [\u2192](${C})`:"";r.push(`**\u{1F3AF} #S${p.id}** ${P}${R}`)}r.push("")}else{let p=Z.data,P=Ie(p.files_modified),C=P.length>0&&P[0]?Ke(P[0],t):"General";C!==T&&(x&&r.push(""),e?r.push(`${o.dim}${C}${o.reset}`):r.push(`**${C}**`),e||(r.push("| ID | Time | T | Title | Read | Work |"),r.push("|----|------|---|-------|------|------|")),T=C,x=!0,M="");let R=Ve(p.created_at),V=p.title||"Untitled",Y=le[p.type]||"\u2022",De=(p.title?.length||0)+(p.subtitle?.length||0)+(p.narrative?.length||0)+JSON.stringify(p.facts||[]).length,X=Math.ceil(De/Ae),W=p.discovery_tokens||0,ee=Ee[p.type]||"\u{1F50D}",ce=W>0?`${ee} ${W.toLocaleString()}`:"-",se=R!==M,_e=se?R:"";if(M=R,ve.has(p.id)){let k=s.fullObservationField==="narrative"?p.narrative:p.facts?Ie(p.facts).join(`
`):null;if(e){let I=se?`${o.dim}${R}${o.reset}`:" ".repeat(R.length),K=s.showReadTokens&&X>0?`${o.dim}(~${X}t)${o.reset}`:"",ue=s.showWorkTokens&&W>0?`${o.dim}(${ee} ${W.toLocaleString()}t)${o.reset}`:"";r.push(`  ${o.dim}#${p.id}${o.reset}  ${I}  ${Y}  ${o.bright}${V}${o.reset}`),k&&r.push(`    ${o.dim}${k}${o.reset}`),(K||ue)&&r.push(`    ${K} ${ue}`),r.push("")}else{x&&(r.push(""),x=!1),r.push(`**#${p.id}** ${_e||"\u2033"} ${Y} **${V}**`),k&&(r.push(""),r.push(k),r.push(""));let I=[];s.showReadTokens&&I.push(`Read: ~${X}`),s.showWorkTokens&&I.push(`Work: ${ce}`),I.length>0&&r.push(I.join(", ")),r.push(""),T=null}}else if(e){let k=se?`${o.dim}${R}${o.reset}`:" ".repeat(R.length),I=s.showReadTokens&&X>0?`${o.dim}(~${X}t)${o.reset}`:"",K=s.showWorkTokens&&W>0?`${o.dim}(${ee} ${W.toLocaleString()}t)${o.reset}`:"";r.push(`  ${o.dim}#${p.id}${o.reset}  ${k}  ${Y}  ${V} ${I} ${K}`)}else{let k=s.showReadTokens?`~${X}`:"",I=s.showWorkTokens?ce:"";r.push(`| #${p.id} | ${_e||"\u2033"} | ${Y} | ${V} | ${k} | ${I} |`)}}x&&r.push("")}let A=g[0],de=l[0];if(s.showLastSummary&&A&&(A.investigated||A.learned||A.completed||A.next_steps)&&(!de||A.created_at_epoch>de.created_at_epoch)&&(r.push(...Q("Investigated",A.investigated,o.blue,e)),r.push(...Q("Learned",A.learned,o.yellow,e)),r.push(...Q("Completed",A.completed,o.green,e)),r.push(...Q("Next Steps",A.next_steps,o.magenta,e))),f&&(r.push(""),r.push("---"),r.push(""),e?(r.push(`${o.bright}${o.magenta}\u{1F4CB} Previously${o.reset}`),r.push(""),r.push(`${o.dim}A: ${f}${o.reset}`)):(r.push("**\u{1F4CB} Previously**"),r.push(""),r.push(`A: ${f}`)),r.push("")),G&&h>0&&D>0){let _=Math.round(h/1e3);r.push(""),e?r.push(`${o.dim}\u{1F4B0} Access ${_}k tokens of past research & decisions for just ${O.toLocaleString()}t. Use the mem-search skill to access memories by ID instead of re-reading files.${o.reset}`):r.push(`\u{1F4B0} Access ${_}k tokens of past research & decisions for just ${O.toLocaleString()}t. Use the mem-search skill to access memories by ID instead of re-reading files.`)}}return i?.close(),r.join(`
