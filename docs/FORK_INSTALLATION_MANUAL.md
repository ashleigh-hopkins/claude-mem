# Installing Claude-Mem from Fork (Manual Method)

> **⚠️ Note:** This is the manual installation method. For a cleaner approach that works better with Claude Code's UI, see [FORK_INSTALLATION.md](./FORK_INSTALLATION.md) (recommended).

This guide covers manually installing claude-mem from your fork (ashleigh-hopkins/claude-mem) by directly cloning into the plugin directory.
